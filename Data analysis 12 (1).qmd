...
The logistic regression model tests whether the year is a significant predictor of obesity. The coefficient for year of -9.132e-16 is nearly zero, with a p-value of 1, indicating no relationship between year and obesity. The Intercept of -1.099 represents the log-odds of obesity in the baseline year.
