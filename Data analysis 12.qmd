...
$$
logit(obese) = \beta_0 + \beta_1 x_i + \epsilon_i, ~~~~~ \epsilon_i \sim N(0, \sigma^2), ~~~~~ i = 1, ... , 14017
$$

Here, logit(obese) is the logit link function, $x_i$ is the age of the ith individual, and $\beta_0$, $\beta_1$ are regression coefficients
