...
<<<<<<< HEAD
As seen from the above table, the p-value indicates that sex is a significant predictor at the 5% significance level. Furthermore, the odds ratio for being obese increase by 0.89 for females.
=======
...
>>>>>>> eff281034a051653bb2dfa8d9154fb7e75b781a5
...
<<<<<<< HEAD
As seen from the table above, all the levels of education are considered significant predictors of the persons BMI group. The odds of a person being obese is 3.05 for a person with a degree, then increases by 0.53-0.84 depending on qualification level.
=======
